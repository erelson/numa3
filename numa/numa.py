...
class NumaMain(object):
    ...
    def app_control(self, loopStart):
        ...
        returns:
            Desired time interval between the current call to app_control and the next call.
        """
...
#            print("")
    ...
    def cmdr_read_msgs(self):
        """
        Notes - Affects:
        - gunbutton
        - turn_mode
        - pan_pos and tilt_pos
        - TODO any more?
        """
        ...
        if buttonval & BUT_R3:  # NOTE this button is also wired to a physical switch
        ...
        if buttonval & BUT_L4:  # NOTE this button is also wired to a physical switch
